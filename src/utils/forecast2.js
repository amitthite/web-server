...
request(options, (error, {body} ) => {
		if (error) {
			...
			callback(undefined, 'AMIT IS Gr8 , Happy birthday from Sachin:  It is currently ' + bodyString.main.temp + ' degress out. It feels like ' + bodyString.main.feels_like + ' degrees.')
		}
	}
)
}
